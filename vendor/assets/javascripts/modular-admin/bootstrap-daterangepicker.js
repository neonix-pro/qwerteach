            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<i class="ion-ios-calendar-outline fa fa-calendar"></i>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="ion-ios-arrow-' + arrow.left + ' glyphicon glyphicon-' + arrow.left + ' fa fa-chevron-' + arrow.left + '"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="ion-ios-arrow-' + arrow.right + ' glyphicon glyphicon-' + arrow.right + ' fa fa-chevron-' + arrow.right + '"></i></th>';
            } else {
                html += '<th></th>';
            }
