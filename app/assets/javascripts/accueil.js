$(window).on('turbolinks:load',  function(e){
    ...
    function resizeTeachers(){
        ...
        $('.section_profs #prof2').css({top:(4*u - 150 ), left:0, width: u*2, height: u*2 });
        $('.section_profs #prof3').css({top:u*4 - 150, left:2*u, width: u*2, height: u*2});
        $('.section_profs #prof4').css({top:u*5, left:u*4, width: 2*u, height: 2*u});
        ...
        $('.section_profs #prof8').css({top:6*u - 150, left:0, width: u*4, height: u*4});
        $('.section_profs #prof9').css({top:5*u, left:4*u, width: u*2, height: u*2});
